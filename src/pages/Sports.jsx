...
export default function Sports() {
  ...
  function saveWorkout(sessionData) {
    const updated = [...savedWorkouts, sessionData];
  ...
  return (
    ...
    >
      ...
      <div
        ...
        onClick={() => saveWorkout(sessionData)}
      >
        Save Workout
      </div>

      {/* RETURN TO MENU — LOWER RIGHT */}
      <div
        style={{
          position: "fixed",
          bottom: "20px",
