...
export default function CoachMessaging() {
  ...
  const handleSendMessage = () => {
    if (newMessage.trim()) {
      setMessages([
        ...messages,
        { id: messages.length + 1, sender: "Coach", text: newMessage, time: "now" }
      ]);
      setNewMessage("");
    }
  };
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
              {conversations.map((conv) => (
                <div
                  ...
                  style={{
                    background: "#111",
                    border: `1px solid ${conv.unread ? COACH_COLOR : "#2a2a2a"}`,
                    borderRadius: "12px",
                    padding: "14px",
                    cursor: "pointer"
                  }}
                  onMouseEnter={(e) => (e.currentTarget.style.borderColor = COACH_COLOR)}
                  onMouseLeave={(e) => (e.currentTarget.style.borderColor = conv.unread ? COACH_COLOR : "#2a2a2a")}
                >
            ...
            >
              {messages.map((msg) => (
                ...
                >
                  <div
                    style={{
                      background: msg.sender === "Coach" ? COACH_COLOR : "#222",
                      color: msg.sender === "Coach" ? BLACK : WHITE,
                      borderRadius: "12px",
                      padding: "10px 12px",
                      maxWidth: "80%",
                      fontSize: "13px"
